...
def detect_faces(frame, net, ln, godIdx=0, badIdx=1):
    # grab dimensions of the frame and initialize the list of results
    (H, W) = frame.shape[:2]
    results = []
    ...
    # apply non-maxima suppression to suppress weak, overlapping bounding boxes
    # print('confidence del Face es: ',confidences, '\n')
    idxs = cv2.dnn.NMSBoxes(boxes, confidences, MIN_CONF_FACE, NMS_THRESH)
